	...
	public void run(){  
        ...
        while (true){  
    	    try{  
                ...
                Client.Message clientMsg = (Client.Message) streamIn.readObject();
                Message msg = new Message(clientMsg.type, clientMsg.sender,
                        clientMsg.content, clientMsg.recipient);
